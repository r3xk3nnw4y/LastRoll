...
class Product(models.Model):
    ...
    color = models.CharField(max_length=30, default="N/A", db_index=True)
    material = models.CharField(max_length=30, default="N/A", db_index=True)
    dice_type = models.CharField(max_length=30, default="N/A", db_index=True)
    stock = models.PositiveIntegerField(default=0)
    image = models.ImageField(upload_to='product_images/', blank=True)
    created_at = models.DateTimeField(default=timezone.now)
    status = models.IntegerField(default=0)
    is_reported = models.BooleanField(default=False)
    report_confirmed = models.BooleanField(default=False)
